...
import schemaContract from '../../prompts/studydeck-format-spec.md?raw';
import quickIntro from '../../prompts/studydeck-quick-intro.md?raw';
import guidedIntro from '../../prompts/studydeck-guided-intro.md?raw';
